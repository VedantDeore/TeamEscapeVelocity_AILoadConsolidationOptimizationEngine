            ...
            <div className="data-table-wrapper" style={{ border: "none" }}>
              <table className="data-table">
                ...
                <tbody>
                  {[
                    {
                      name: "Daily Consolidation - Mar 7",
                      type: "Consolidation",
                      format: "PDF",
                      date: "2026-03-07 06:15",
                      size: "2.4 MB",
                    },
                    {
                      name: "Weekly Utilization - W10",
                      type: "Utilization",
                      format: "Excel",
                    ...
                    {
                      name: "Route Efficiency - Feb 2026",
                      type: "Route",
                      format: "PDF",
                    ...
                    <tr key={i}>
                      ...
                      <td>
                        <span className="badge badge-ghost">{row.type}</span>
                      </td>
                      <td>
                        <span
                          className={`badge ${row.format === "PDF" ? "badge-danger" : row.format === "Excel" ? "badge-success" : "badge-primary"}`}
                        >
                          {row.format}
                        </span>
                      </td>
