      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Interactive Leaflet map showing optimized delivery routes
          </p>
        </div>
        <div className="tabs">
          <button
            ...
            {routes.map((route) => (
              <div
                ...
                style={{
                  cursor: "pointer",
                  borderColor:
                    selectedRoute?.id === route.id ? route.color : undefined,
                  boxShadow:
                    selectedRoute?.id === route.id
                      ? `0 0 15px ${route.color}30`
                      : undefined,
                      ...
                      >
                        ...
                        <div
                          style={{
                            ...
                            borderRadius: "50%",
                            background:
                              point.type === "depot" ? "#f59e0b" : route.color,
