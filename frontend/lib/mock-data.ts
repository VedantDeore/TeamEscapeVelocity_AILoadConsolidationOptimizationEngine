...
const cargoTypes: Shipment["cargoType"][] = [
  "general",
  "fragile",
  "refrigerated",
  "hazardous",
...
function generateShipments(count: number): Shipment[] {
  ...
  for (let i = 0; i < count; i++) {
    ...
    shipments.push({
      ...
      status:
        i < 90 ? "pending" : statuses[Math.floor(rng() * statuses.length)],
      createdAt: new Date(
        Date.now() - rng() * 7 * 24 * 3600 * 1000,
      ).toISOString(),
    });
  }
  return shipments;
...
const clusterData: Cluster[] = [
  {
    ...
    planId: "plan-001",
    vehicleId: "v3",
    vehicleName: "Ashok Leyland 1612",
    shipmentIds: ["shp-0001", "shp-0005", "shp-0012", "shp-0018", "shp-0025"],
    utilizationPct: 91,
    totalWeight: 10920,
    totalVolume: 38.2,
    routeDistanceKm: 1420,
    estimatedCost: 34080,
    estimatedCo2: 96.5,
    status: "accepted",
  },
  ...
  },
  {
    ...
    planId: "plan-001",
    vehicleId: "v2",
    vehicleName: "Eicher 10.59",
    shipmentIds: ["shp-0003", "shp-0008", "shp-0015"],
    utilizationPct: 78,
    totalWeight: 5460,
    totalVolume: 21.8,
    routeDistanceKm: 680,
  ...
  },
  {
    ...
    planId: "plan-001",
    vehicleId: "v5",
    vehicleName: "BharatBenz 2823",
    shipmentIds: ["shp-0004", "shp-0010", "shp-0016", "shp-0022", "shp-0028"],
    utilizationPct: 84,
    totalWeight: 15120,
    totalVolume: 46.2,
    routeDistanceKm: 2100,
    estimatedCost: 58800,
    estimatedCo2: 168.4,
    status: "pending",
  },
  ...
  },
  {
    ...
    vehicleId: "v3",
    vehicleName: "Ashok Leyland 1612",
    shipmentIds: ["shp-0014", "shp-0019", "shp-0023", "shp-0027"],
    utilizationPct: 89,
    totalWeight: 10680,
    totalVolume: 37.4,
    routeDistanceKm: 1680,
    estimatedCost: 40320,
    estimatedCo2: 114.2,
    status: "accepted",
  },
  {
    ...
    vehicleId: "v2",
    vehicleName: "Eicher 10.59",
    shipmentIds: ["shp-0017", "shp-0024", "shp-0030"],
    utilizationPct: 65,
    totalWeight: 4550,
    totalVolume: 18.2,
    routeDistanceKm: 520,
...
export const mockActivityFeed: ActivityItem[] = [
  {
    ...
    type: "consolidation",
    message:
      'Consolidation plan "March 7 Daily" created — 31 clusters from 150 shipments',
    timestamp: "2 min ago",
    icon: "layers",
  },
  {
    id: "a2",
    type: "optimization",
    message: "Route optimization complete — 34% fewer trips, ₹1.4L saved",
    timestamp: "5 min ago",
    icon: "route",
  },
  {
    id: "a3",
    type: "shipment",
    message: "12 new shipments uploaded from CSV — Delhi → Mumbai route",
  ...
  },
  {
    ...
    type: "alert",
    message:
      "8 Chennai-bound shipments detected — consolidation could save ₹18,000",
  ...
  },
  {
    id: "a5",
    type: "consolidation",
    message: "Cluster CL-001 accepted by logistics manager",
    timestamp: "1 hr ago",
    icon: "check-circle",
  },
  {
    id: "a6",
    type: "shipment",
    message: "Priority shipment SHP-0089 marked as Critical",
    timestamp: "2 hrs ago",
    icon: "alert-circle",
  },
  {
    id: "a7",
    type: "optimization",
    message: "3D bin packing optimized — vehicle utilization up to 91%",
    timestamp: "3 hrs ago",
    icon: "box",
  },
];
...
export const mockRoutes: Route[] = [
  ...
  },
  {
    ...
    points: [
      ...
      { lat: 13.0827, lng: 80.27, city: "Chennai", type: "delivery" },
    ],
    totalDistanceKm: 1850,
    estimatedTime: "28h 40m",
    fuelCost: 59200,
  },
  {
    id: "r3",
...
export const mockChatHistory: ChatMessage[] = [
  {
    ...
    role: "assistant",
    content:
      "👋 Hello! I'm Lorri, your AI logistics co-pilot. I can help you with shipment consolidation, route optimization, and capacity planning. What would you like to know?",
    timestamp: "10:00 AM",
  },
];
...
export const mockReports: Report[] = [
  {
    ...
    lastGenerated: "2026-03-07 06:00",
    icon: "layers",
  },
  {
    id: "rpt-2",
    ...
    lastGenerated: "2026-03-06 18:00",
    icon: "gauge",
  },
  {
    id: "rpt-3",
    ...
    lastGenerated: "2026-03-06 12:00",
    icon: "indian-rupee",
  },
  {
    id: "rpt-4",
    ...
    lastGenerated: "2026-03-05 18:00",
    icon: "leaf",
  },
  {
    id: "rpt-5",
    ...
    lastGenerated: "2026-03-05 06:00",
    icon: "map",
  },
];
...
export const mockDepots: DepotLocation[] = [
  { id: "d1", name: "Bhiwandi Hub", city: "Mumbai", lat: 19.3002, lng: 73.0617 },
  { id: "d2", name: "Gurugram Center", city: "Delhi", lat: 28.4595, lng: 76.9950 },
  { id: "d3", name: "Hoskote Logistics", city: "Bangalore", lat: 13.0722, lng: 77.7981 },
  { id: "d4", name: "Sriperumbudur Hub", city: "Chennai", lat: 12.9715, lng: 79.9481 },
  { id: "d5", name: "Dhulagarh Park", city: "Kolkata", lat: 22.5695, lng: 88.1633 },
  { id: "d6", name: "Sanand Center", city: "Ahmedabad", lat: 22.9868, lng: 72.3814 },
  { id: "d7", name: "Chakan Hub", city: "Pune", lat: 18.7523, lng: 73.8562 },
  { id: "d8", name: "Medchal Depot", city: "Hyderabad", lat: 17.6295, lng: 78.4832 },
];
